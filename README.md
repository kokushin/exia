...
ゲームエンジン名の「Exia(エクシア)」は SHIFT UP CORP の作品「勝利の女神:NIKKE」に登場するキャラクターです。

同タイトルの UI や演出を参考していることや、エクシア自身がゲーム好きな性格ということもありこの名前に決めました。<br>
お尻に注目されがちのゲームですが、ストーリーや UI などクオリティ高いのでぜひ一度プレイしてみてください。
